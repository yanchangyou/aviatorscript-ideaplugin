...
public class MyLanguageAssignStatementImpl extends ASTWrapperPsiElement implements MyLanguageAssignStatement {

  public MyLanguageAssignStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MyLanguageAssignExpress getAssignExpress() {
    return findNotNullChildByClass(MyLanguageAssignExpress.class);
  }
