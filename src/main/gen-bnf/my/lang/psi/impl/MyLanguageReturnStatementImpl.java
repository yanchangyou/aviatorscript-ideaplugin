...
public class MyLanguageReturnStatementImpl extends ASTWrapperPsiElement implements MyLanguageReturnStatement {

  public MyLanguageReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
