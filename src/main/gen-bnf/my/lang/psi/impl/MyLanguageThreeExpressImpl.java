...
public class MyLanguageThreeExpressImpl extends ASTWrapperPsiElement implements MyLanguageThreeExpress {

  public MyLanguageThreeExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull MyLanguageVisitor<R> visitor) {
    return visitor.visitThreeExpress(this);
  }
