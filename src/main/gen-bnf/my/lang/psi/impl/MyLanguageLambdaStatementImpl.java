...
public class MyLanguageLambdaStatementImpl extends ASTWrapperPsiElement implements MyLanguageLambdaStatement {

  public MyLanguageLambdaStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MyLanguageLambdaExpress getLambdaExpress() {
    return findNotNullChildByClass(MyLanguageLambdaExpress.class);
  }
