...
public class MyLanguageUseExpressImpl extends ASTWrapperPsiElement implements MyLanguageUseExpress {

  public MyLanguageUseExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public <R> R accept(@NotNull MyLanguageVisitor<R> visitor) {
    return visitor.visitUseExpress(this);
  }
